      subroutine pegproppsv(ma,mai,l1,l2,ypsv,ypsv0,k)
      implicit none
c
...
c
      if(l1.eq.l2)then
        ...
        do l=l1+1,l2
          h0=hp(l-1)
	    n=nno(l-1)
          wave(1)=cdexp(dcmplx(-k*h0,0.d0))
          wave(2)=wave(1)
          wave(3)=cdexp(ka(n)*dcmplx(-h0,0.d0))
c
...
c
          ...
          c1(3,1)=(0.d0,0.d0)
          c1(4,1)=c1(4,1)*wave(2)*wave(1)
          c1(5,1)=(0.d0,0.d0)
          c1(6,1)=c1(6,1)*wave(3)*wave(1)
c
          c1(1,2)=(0.d0,0.d0)
          c1(2,2)=c1(2,2)*wave(1)*wave(2)
          c1(3,2)=(1.d0,0.d0)
          c1(4,2)=c1(4,2)*wave(2)*wave(2)
          c1(5,2)=(0.d0,0.d0)
          c1(6,2)=c1(6,2)*wave(3)*wave(2)
c
          c1(1,3)=(0.d0,0.d0)
          c1(2,3)=c1(2,3)*wave(1)*wave(3)
          c1(3,3)=(0.d0,0.d0)
          c1(4,3)=c1(4,3)*wave(2)*wave(3)
          c1(5,3)=(1.d0,0.d0)
...
c
	    c1(1,1)=c1(1,1)*wave(1)*wave(1)
 	    c1(2,1)=(1.d0,0.d0)
	    c1(3,1)=c1(3,1)*wave(2)*wave(1)
          c1(4,1)=(0.d0,0.d0)
	    c1(5,1)=c1(5,1)*wave(3)*wave(1)
          c1(6,1)=(0.d0,0.d0)
c
          c1(1,2)=c1(1,2)*wave(1)*wave(2)
          c1(2,2)=(0.d0,0.d0)
          c1(3,2)=c1(3,2)*wave(2)*wave(2)
          c1(4,2)=(1.d0,0.d0)
          c1(5,2)=c1(5,2)*wave(3)*wave(2)
          c1(6,2)=(0.d0,0.d0)
c
          c1(1,3)=c1(1,3)*wave(1)*wave(3)
          c1(2,3)=(0.d0,0.d0)
          c1(3,3)=c1(3,3)*wave(2)*wave(3)
          c1(4,3)=(0.d0,0.d0)
